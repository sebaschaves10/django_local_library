...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-2lp64#wbel@x8rb(1+lxubruqdnr(3gi47_$gc5=8t^u(y!mqs')
...
CSRF_TRUSTED_ORIGINS = ['https://web-production-f35b.up.railway.app']
